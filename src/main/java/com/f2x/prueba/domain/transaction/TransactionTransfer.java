...
@Transactional
public class TransactionTransfer implements TransactionRules {
    ...
    public Transaction execute() {
        BigDecimal netAmount = transaction.calculateNetAmount(sourceProduct.isGmfExempt(), destinationProduct.isGmfExempt());
